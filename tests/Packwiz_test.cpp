...
class PackwizTest : public QObject {
   ...
   private slots:
    ...
    void loadFromFile_Modrinth()
    {
        ...
        QCOMPARE(metadata.side, Resources::Side::Client);
        ...
        QCOMPARE(metadata.provider, Resources::Platform::Modrinth);
    ...
    void loadFromFile_Curseforge()
    {
        ...
        QCOMPARE(metadata.side, Resources::Side::Universal);
        ...
        QCOMPARE(metadata.provider, Resources::Platform::Curseforge);
