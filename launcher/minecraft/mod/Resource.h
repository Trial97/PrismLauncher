...
enum class SortType { NAME, DATE, VERSION, ENABLED, PACK_FORMAT, PROVIDER, SIZE, SIDE, MC_VERSIONS, LOADERS, RELEASE_TYPE, DEPENDENCY };
...
class Resource : public QObject {
   ...
   public:
    ...
    [[nodiscard]] virtual QString jarId() const { return {}; }
